...
public class SantaClaus {
    ...
    public static void main(String[] args) {
        ...
        for(int i=0;i<M;i++) {
            ...
            g.addVertex(fromIndex, fromName);
            g.addVertex(toIndex, toName);

            g.addEdge(fromIndex, toIndex, distance);
        }

        String startingPoint = sc.next();
        int startIndex = vertices.get(startingPoint);

        List<Edge> res = g.prim(startIndex);
